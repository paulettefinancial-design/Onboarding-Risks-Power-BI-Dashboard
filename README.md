...
- Explore the sensitivity chart, volatility chart, and summary metrics  
- Use slicers to filter by risk category  
- Review insights to understand which risks drive schedule overruns  
